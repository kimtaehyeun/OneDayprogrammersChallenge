package chellenge.programmers.week4.thursday;
...
트럭이 최대 bridge_length대 올라갈 수 있으며, 다리는 weight 이하까지의
 무게를 견딜 수 있습니다. 단, 다리에 완전히 오르지 않은 트럭의 무게는 무시합니다.
...
public class challenge1 {
	...
	static class Truck{
		int truck_weight;
		int time;
		public Truck(int truck_weight,int time){
